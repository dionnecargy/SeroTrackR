...
![](../reference/figures/SeroTrackR_PvSeroApp.jpeg)
...
#> [[1]]
#> # A tibble: 252 × 12
#>    SampleID Plate  QC_total      EBP    LF005    LF010   LF016      MSP8 PTEX150
#>    <chr>    <chr>  <chr>       <dbl>    <dbl>    <dbl>   <dbl>     <dbl>   <dbl>
#>  1 ABC013   plate1 pass     0.000334 0.00150  0.000216 0.00146 0.0000195 1.59e-4
#>  2 ABC097   plate2 pass     0.000432 0.00156  0.000194 0.00134 0.0000195 1.55e-4
#>  3 ABC181   plate3 pass     0.000382 0.00158  0.000214 0.00137 0.0000195 1.58e-4
#>  4 ABC022   plate1 pass     0.02     0.02     0.000737 0.0195  0.000625  3.14e-4
#>  5 ABC106   plate2 pass     0.00571  0.0194   0.000746 0.0195  0.000626  3.08e-4
#>  6 ABC190   plate3 pass     0.00983  0.02     0.000740 0.02    0.000602  3.17e-4
#>  7 ABC023   plate1 pass     0.000106 0.00832  0.000131 0.00129 0.000112  1.76e-3
#>  8 ABC107   plate2 pass     0.000109 0.00738  0.000112 0.00117 0.0000973 1.56e-3
#>  9 ABC191   plate3 pass     0.000102 0.00856  0.000130 0.00122 0.000107  1.83e-3
#> 10 ABC024   plate1 pass     0.000200 0.000391 0.000283 0.00134 0.0000534 5.87e-5
#> # ℹ 242 more rows
#> # ℹ 3 more variables: PvCSS <dbl>, RBP2b.P87 <dbl>, pred_class_max <fct>
#> 
#> [[2]]
```

![](02_PvSeroApp_R_Tutorial_files/figure-html/runPvSeroPipeline%20with%20classification-1.png)

    #> 
    #> [[3]]

![](02_PvSeroApp_R_Tutorial_files/figure-html/runPvSeroPipeline%20with%20classification-2.png)
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/runPvSeroPipeline%20with%20classification-3.png)
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/runPvSeroPipeline%20with%20classification-4.png)
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/runPvSeroPipeline%20with%20classification-5.png)
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/runPvSeroPipeline%20with%20classification-6.png)
...
`sens_spec = "maximised"`. If you change it to another type of
threshold, then the suffix of that column will change accordingly.
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/std%20curve%20plot%20tab%201-1.png)
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/bead%20counts%20plot%20tab%201-1.png)
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/blanks%20qc%20plot%20tab%201-1.png)
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/model%20output%20plot%20tab%201-1.png)
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/model%20output%20plot%20tab%201-2.png)
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/model%20output%20plot%20tab%201-3.png)
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/std%20curve%20plot%20tab%202-1.png)
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/std%20curve%20plot%20tab%202-2.png)
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/std%20curve%20plot%20tab%202-3.png)
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/std%20curve%20plot%20tab%202-4.png)
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/std%20curve%20plot%20tab%202-5.png)
...
![](02_PvSeroApp_R_Tutorial_files/figure-html/std%20curve%20plot%20tab%202-6.png)
