#' ARCHIVE: Read Serological Data and 5-point Standard Curve
#'
...
#'
#' @return A data frame containing: (i) Results from MAGPIX (MFI), (ii), Counts for each sample, (iii) Processed RAU values for each sample
#' @export
#'
