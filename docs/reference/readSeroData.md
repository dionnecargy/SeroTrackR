...
and matches the sample names from the plate layout based on their
plate/well location.
...
List of data frames: (i) raw data output, (ii) cleaned all results (iii)
count data, (iv) blanks only, (v) standards only, (vi) run information.
